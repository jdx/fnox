---
description: "Find fnox commands for reading secrets, running applications, configuring providers, and managing caches and temporary credentials."
---
...
- [`fnox proxy <SUBCOMMAND>`](/cli/proxy.md)
...
- [`fnox scan [FLAGS] [DIR]`](/cli/scan.md)
